const translations = {
  pt: {
    ...
    eventIntro: `O nosso salão de eventos familiares oferece um cenário único para
            ...
            autenticidade.`,
    firstEventTitle: "Celebrações Íntimas",
    firstEventFirst: "Uso exclusivo do salão",
    firstEventSecond: "Decoração clássica incluída",
    firstEventThird: "Apoio na organização",
    firstEventFourth: "Acesso à cozinha",
    firstEventExtra: "Até X pessoas",
    secondEventTitle: "Eventos Familiares",
    secondEventFirst: "Espaços interior e exterior",
    secondEventSecond: "Equipamento audiovisual",
    secondEventThird: "Catering opcional",
    secondEventFourth: "Fotografia de evento",
    secondEventExtra: "Até X pessoas",
    thirdEventTitle: "Ocasiões Especiais",
    thirdEventFirst: "Planeamento sob medida",
    thirdEventSecond: "Experiências exclusivas",
    thirdEventThird: "Serviço completo",
    thirdEventFourth: "Consultoria personalizada",
    thirdEventExtra: "Personalizado",
...
every event becomes a memorable experience wrapped in elegance and authenticity.`,
    firstEventTitle: "Intimate Celebrations",
    firstEventFirst: "Exclusive use of the hall",
    firstEventSecond: "Classic decoration included",
    firstEventThird: "Event organization support",
    firstEventFourth: "Kitchen access",
    firstEventExtra: "Up to X people",
    secondEventTitle: "Family Gatherings",
    secondEventFirst: "Indoor and outdoor spaces",
    secondEventSecond: "Audiovisual equipment",
    secondEventThird: "Optional catering service",
    secondEventFourth: "Event photography",
    secondEventExtra: "Up to X people",
    thirdEventTitle: "Special Occasions",
    thirdEventFirst: "Tailor-made planning",
    thirdEventSecond: "Exclusive experiences",
    thirdEventThird: "Full service",
    thirdEventFourth: "Personalized consulting",
    thirdEventExtra: "Customized",
...
chaque événement devient une expérience mémorable empreinte d’élégance et d’authenticité.`,
    ...
    firstEventTitle: "Célébrations Intimes",
    firstEventFirst: "Utilisation exclusive de la salle",
    firstEventSecond: "Décoration classique incluse",
    firstEventThird: "Accompagnement dans l’organisation",
    firstEventFourth: "Accès à la cuisine",
    firstEventExtra: "Jusqu’à X personnes",

    secondEventTitle: "Rencontres Familiales",
    secondEventFirst: "Espaces intérieurs et extérieurs",
    secondEventSecond: "Équipement audiovisuel",
    secondEventThird: "Service traiteur en option",
    secondEventFourth: "Photographie d’événements",
    secondEventExtra: "Jusqu’à X personnes",

    thirdEventTitle: "Occasions Spéciales",
    thirdEventFirst: "Planification sur mesure",
    thirdEventSecond: "Expériences exclusives",
    thirdEventThird: "Service complet",
    thirdEventFourth: "Conseil personnalisé",
    thirdEventExtra: "Personnalisé",
...
cada evento se convierte en una experiencia memorable llena de elegancia y autenticidad.`,
    ...
    firstEventTitle: "Celebraciones Íntimas",
    firstEventFirst: "Uso exclusivo de la sala",
    firstEventSecond: "Decoración clásica incluida",
    firstEventThird: "Soporte en la organización",
    firstEventFourth: "Acceso a la cocina",
    firstEventExtra: "Hasta X personas",

    secondEventTitle: "Reuniones Familiares",
    secondEventFirst: "Espacios interiores y exteriores",
    secondEventSecond: "Equipamiento audiovisual",
    secondEventThird: "Servicio de catering opcional",
    secondEventFourth: "Fotografía del evento",
    secondEventExtra: "Hasta X personas",

    thirdEventTitle: "Ocasiones Especiales",
    thirdEventFirst: "Planificación a medida",
    thirdEventSecond: "Experiencias exclusivas",
    thirdEventThird: "Servicio completo",
    thirdEventFourth: "Asesoramiento personalizado",
    thirdEventExtra: "Personalizado",
